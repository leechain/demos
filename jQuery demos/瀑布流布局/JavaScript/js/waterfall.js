window.onload=function(){
    ...
    window.onscroll=function(){
        if(checkscrollside()){
            ...
            waterfall('main','pin');//新加载的图片需要调用此封装函数
        };
    }
}
...
function getClassObj(parent,className){
    var obj=parent.getElementsByTagName('*');//获取父元素的所有子元素
...
function checkscrollside(){
    ...
    var scrollTop=document.documentElement.scrollTop||document.body.scrollTop;//注意解决兼容性（标准模式和混杂模式）
